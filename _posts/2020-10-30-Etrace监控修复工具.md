# ETrace是一款无侵入监控JVM，热修复，动态AOP日志，查看线程堆栈，查找bug的开源工具
1. 1.2.1版更名为ETrace(easy trace)
2. 1.2.2版本开始，已经上传至 [中央maven仓库](https://mvnrepository.com/search?q=com.github.nobugboy)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210120150301222.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0RheV9EYXlfTm9fQnVn,size_16,color_FFFFFF,t_70)
...
***点击对应线程名即可看到当前堆栈信息（所以为什么线程名是有意义的？）***
![在这里插入图片描述](https://img-blog.csdnimg.cn/20210120150417534.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0RheV9EYXlfTm9fQnVn,size_16,color_FFFFFF,t_70)
